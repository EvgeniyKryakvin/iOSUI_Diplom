...
class HabitViewController: UIViewController {
    ...
    private let navBar: UINavigationBar = {
        ...
        let navLeftItem = UINavigationItem()
        let navRightItem = UINavigationItem()
        let cancelItem = UIBarButtonItem(title: "Отменить", style: UIBarButtonItem.Style.done, target: self, action: #selector(cancelHabit))
        cancelItem.tintColor = UIColor(red: 161/255, green: 22/255, blue: 204/255, alpha: 1)
        let doneItem = UIBarButtonItem(title: "Сохранить", style: UIBarButtonItem.Style.done, target: self, action: #selector(saveHabit))
        doneItem.tintColor = UIColor(red: 161/255, green: 22/255, blue: 204/255, alpha: 1)
        navRightItem.rightBarButtonItem = doneItem
        navLeftItem.leftBarButtonItem = cancelItem
        navBar.setItems([navLeftItem, navRightItem], animated: false)
